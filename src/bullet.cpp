...
static void finalize_btBroadphaseProxy( _ref(btBroadphaseProxy)* _this ) { free_ref(_this); }
HL_PRIM void HL_NAME(btBroadphaseProxy_delete)( _ref(btBroadphaseProxy)* _this ) {
	free_ref(_this);
}
DEFINE_PRIM(_VOID, btBroadphaseProxy_delete, _IDL);
...
HL_PRIM bool HL_NAME(btCollisionObject_mergesSimulationIslands0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->mergesSimulationIslands();
}
DEFINE_PRIM(_BOOL, btCollisionObject_mergesSimulationIslands0, _IDL);

HL_PRIM HL_CONST _ref(btVector3)* HL_NAME(btCollisionObject_getAnisotropicFriction0)(_ref(btCollisionObject)* _this) {
	return alloc_ref_const(&(_unref(_this)->getAnisotropicFriction()),btVector3);
}
DEFINE_PRIM(_IDL, btCollisionObject_getAnisotropicFriction0, _IDL);
...
HL_PRIM bool HL_NAME(btCollisionObject_hasAnisotropicFriction1)(_ref(btCollisionObject)* _this, int frictionMode) {
	return _unref(_this)->hasAnisotropicFriction(frictionMode);
}
DEFINE_PRIM(_BOOL, btCollisionObject_hasAnisotropicFriction1, _IDL _I32);
...
HL_PRIM float HL_NAME(btCollisionObject_getContactProcessingThreshold0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getContactProcessingThreshold();
}
DEFINE_PRIM(_F32, btCollisionObject_getContactProcessingThreshold0, _IDL);
...
HL_PRIM bool HL_NAME(btCollisionObject_hasContactResponse0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->hasContactResponse();
}
DEFINE_PRIM(_BOOL, btCollisionObject_hasContactResponse0, _IDL);
...
HL_PRIM void HL_NAME(btCollisionObject_setIgnoreCollisionCheck2)(_ref(btCollisionObject)* _this, _ref(btCollisionObject)* co, bool ignoreCollisionCheck) {
	_unref(_this)->setIgnoreCollisionCheck(_unref(co), ignoreCollisionCheck);
}
DEFINE_PRIM(_VOID, btCollisionObject_setIgnoreCollisionCheck2, _IDL _IDL _BOOL);

HL_PRIM bool HL_NAME(btCollisionObject_checkCollideWithOverride1)(_ref(btCollisionObject)* _this, _ref(btCollisionObject)* co) {
	return _unref(_this)->checkCollideWithOverride(_unref(co));
}
DEFINE_PRIM(_BOOL, btCollisionObject_checkCollideWithOverride1, _IDL _IDL);

HL_PRIM int HL_NAME(btCollisionObject_getActivationState0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getActivationState();
}
DEFINE_PRIM(_I32, btCollisionObject_getActivationState0, _IDL);
...
HL_PRIM void HL_NAME(btCollisionObject_setDeactivationTime1)(_ref(btCollisionObject)* _this, float time) {
	_unref(_this)->setDeactivationTime(time);
}
DEFINE_PRIM(_VOID, btCollisionObject_setDeactivationTime1, _IDL _F32);

HL_PRIM float HL_NAME(btCollisionObject_getDeactivationTime0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getDeactivationTime();
}
DEFINE_PRIM(_F32, btCollisionObject_getDeactivationTime0, _IDL);
...
HL_PRIM float HL_NAME(btCollisionObject_getRestitution0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getRestitution();
}
DEFINE_PRIM(_F32, btCollisionObject_getRestitution0, _IDL);
...
HL_PRIM float HL_NAME(btCollisionObject_getFriction0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getFriction();
}
DEFINE_PRIM(_F32, btCollisionObject_getFriction0, _IDL);
...
HL_PRIM float HL_NAME(btCollisionObject_getRollingFriction0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getRollingFriction();
}
DEFINE_PRIM(_F32, btCollisionObject_getRollingFriction0, _IDL);

HL_PRIM void HL_NAME(btCollisionObject_setSpinningFriction1)(_ref(btCollisionObject)* _this, float frict) {
	_unref(_this)->setSpinningFriction(frict);
}
DEFINE_PRIM(_VOID, btCollisionObject_setSpinningFriction1, _IDL _F32);

HL_PRIM float HL_NAME(btCollisionObject_getSpinningFriction0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getSpinningFriction();
}
DEFINE_PRIM(_F32, btCollisionObject_getSpinningFriction0, _IDL);

HL_PRIM void HL_NAME(btCollisionObject_setContactStiffnessAndDamping2)(_ref(btCollisionObject)* _this, float stiffness, float damping) {
	_unref(_this)->setContactStiffnessAndDamping(stiffness, damping);
}
DEFINE_PRIM(_VOID, btCollisionObject_setContactStiffnessAndDamping2, _IDL _F32 _F32);

HL_PRIM float HL_NAME(btCollisionObject_getContactStiffness0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getContactStiffness();
}
DEFINE_PRIM(_F32, btCollisionObject_getContactStiffness0, _IDL);

HL_PRIM float HL_NAME(btCollisionObject_getContactDamping0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getContactDamping();
}
DEFINE_PRIM(_F32, btCollisionObject_getContactDamping0, _IDL);
...
HL_PRIM HL_CONST _ref(btBroadphaseProxy)* HL_NAME(btCollisionObject_getBroadphaseHandle0)(_ref(btCollisionObject)* _this) {
	return alloc_ref_const((_unref(_this)->getBroadphaseHandle()),btBroadphaseProxy);
}
DEFINE_PRIM(_IDL, btCollisionObject_getBroadphaseHandle0, _IDL);

HL_PRIM _ref(btTransform)* HL_NAME(btCollisionObject_getInterpolationWorldTransform0)(_ref(btCollisionObject)* _this) {
	return alloc_ref(new btTransform(_unref(_this)->getInterpolationWorldTransform()),btTransform);
}
DEFINE_PRIM(_IDL, btCollisionObject_getInterpolationWorldTransform0, _IDL);

HL_PRIM void HL_NAME(btCollisionObject_setInterpolationWorldTransform1)(_ref(btCollisionObject)* _this, _ref(btTransform)* trans) {
	_unref(_this)->setInterpolationWorldTransform(*_unref(trans));
}
DEFINE_PRIM(_VOID, btCollisionObject_setInterpolationWorldTransform1, _IDL _IDL);

HL_PRIM void HL_NAME(btCollisionObject_setInterpolationLinearVelocity1)(_ref(btCollisionObject)* _this, _ref(btVector3)* linvel) {
	_unref(_this)->setInterpolationLinearVelocity(*_unref(linvel));
}
DEFINE_PRIM(_VOID, btCollisionObject_setInterpolationLinearVelocity1, _IDL _IDL);

HL_PRIM void HL_NAME(btCollisionObject_setInterpolationAngularVelocity1)(_ref(btCollisionObject)* _this, _ref(btVector3)* angvel) {
	_unref(_this)->setInterpolationAngularVelocity(*_unref(angvel));
}
DEFINE_PRIM(_VOID, btCollisionObject_setInterpolationAngularVelocity1, _IDL _IDL);

HL_PRIM HL_CONST _ref(btVector3)* HL_NAME(btCollisionObject_getInterpolationLinearVelocity0)(_ref(btCollisionObject)* _this) {
	return alloc_ref_const(&(_unref(_this)->getInterpolationLinearVelocity()),btVector3);
}
DEFINE_PRIM(_IDL, btCollisionObject_getInterpolationLinearVelocity0, _IDL);

HL_PRIM HL_CONST _ref(btVector3)* HL_NAME(btCollisionObject_getInterpolationAngularVelocity0)(_ref(btCollisionObject)* _this) {
	return alloc_ref_const(&(_unref(_this)->getInterpolationAngularVelocity()),btVector3);
}
DEFINE_PRIM(_IDL, btCollisionObject_getInterpolationAngularVelocity0, _IDL);

HL_PRIM int HL_NAME(btCollisionObject_getIslandTag0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getIslandTag();
}
DEFINE_PRIM(_I32, btCollisionObject_getIslandTag0, _IDL);

HL_PRIM void HL_NAME(btCollisionObject_setIslandTag1)(_ref(btCollisionObject)* _this, int tag) {
	_unref(_this)->setIslandTag(tag);
}
DEFINE_PRIM(_VOID, btCollisionObject_setIslandTag1, _IDL _I32);

HL_PRIM int HL_NAME(btCollisionObject_getCompanionId0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getCompanionId();
}
DEFINE_PRIM(_I32, btCollisionObject_getCompanionId0, _IDL);

HL_PRIM void HL_NAME(btCollisionObject_setCompanionId1)(_ref(btCollisionObject)* _this, int id) {
	_unref(_this)->setCompanionId(id);
}
DEFINE_PRIM(_VOID, btCollisionObject_setCompanionId1, _IDL _I32);

HL_PRIM int HL_NAME(btCollisionObject_getWorldArrayIndex0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getWorldArrayIndex();
}
DEFINE_PRIM(_I32, btCollisionObject_getWorldArrayIndex0, _IDL);

HL_PRIM void HL_NAME(btCollisionObject_setWorldArrayIndex1)(_ref(btCollisionObject)* _this, int ix) {
	_unref(_this)->setWorldArrayIndex(ix);
}
DEFINE_PRIM(_VOID, btCollisionObject_setWorldArrayIndex1, _IDL _I32);

HL_PRIM float HL_NAME(btCollisionObject_getHitFraction0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getHitFraction();
}
DEFINE_PRIM(_F32, btCollisionObject_getHitFraction0, _IDL);

HL_PRIM void HL_NAME(btCollisionObject_setHitFraction1)(_ref(btCollisionObject)* _this, float hitFraction) {
	_unref(_this)->setHitFraction(hitFraction);
}
DEFINE_PRIM(_VOID, btCollisionObject_setHitFraction1, _IDL _F32);
...
HL_PRIM float HL_NAME(btCollisionObject_getCcdSweptSphereRadius0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getCcdSweptSphereRadius();
}
DEFINE_PRIM(_F32, btCollisionObject_getCcdSweptSphereRadius0, _IDL);
...
HL_PRIM float HL_NAME(btCollisionObject_getCcdMotionThreshold0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getCcdMotionThreshold();
}
DEFINE_PRIM(_F32, btCollisionObject_getCcdMotionThreshold0, _IDL);

HL_PRIM float HL_NAME(btCollisionObject_getCcdSquareMotionThreshold0)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getCcdSquareMotionThreshold();
}
DEFINE_PRIM(_F32, btCollisionObject_getCcdSquareMotionThreshold0, _IDL);
...
HL_PRIM int HL_NAME(btCollisionObject_getUserIndex20)(_ref(btCollisionObject)* _this) {
	return _unref(_this)->getUserIndex2();
}
DEFINE_PRIM(_I32, btCollisionObject_getUserIndex20, _IDL);
...
HL_PRIM void HL_NAME(btCollisionObject_setUserIndex21)(_ref(btCollisionObject)* _this, int index) {
	_unref(_this)->setUserIndex2(index);
}
DEFINE_PRIM(_VOID, btCollisionObject_setUserIndex21, _IDL _I32);

HL_PRIM bool HL_NAME(btCollisionObject_checkCollideWith1)(_ref(btCollisionObject)* _this, _ref(btCollisionObject)* co) {
	return _unref(_this)->checkCollideWith(_unref(co));
}
DEFINE_PRIM(_BOOL, btCollisionObject_checkCollideWith1, _IDL _IDL);
...
HL_PRIM HL_CONST float HL_NAME(btManifoldPoint_getAppliedImpulse0)(_ref(btManifoldPoint)* _this) {
	return _unref(_this)->getAppliedImpulse();
}
DEFINE_PRIM(_F32, btManifoldPoint_getAppliedImpulse0, _IDL);

HL_PRIM HL_CONST float HL_NAME(btManifoldPoint_getDistance0)(_ref(btManifoldPoint)* _this) {
	return _unref(_this)->getDistance();
}
DEFINE_PRIM(_F32, btManifoldPoint_getDistance0, _IDL);
...
HL_PRIM void HL_NAME(btOverlappingPairCache_cleanProxyFromPairs2)(_ref(btOverlappingPairCache)* _this, _ref(btBroadphaseProxy)* proxy, _ref(btDispatcher)* dispatcher) {
	_unref(_this)->cleanProxyFromPairs(_unref(proxy), _unref(dispatcher));
}
DEFINE_PRIM(_VOID, btOverlappingPairCache_cleanProxyFromPairs2, _IDL _IDL _IDL);
...
HL_PRIM _ref(btOverlappingPairCache)* HL_NAME(btBroadphaseInterface_getOverlappingPairCache0)(_ref(btBroadphaseInterface)* _this) {
	return alloc_ref((_unref(_this)->getOverlappingPairCache()),btOverlappingPairCache);
}
DEFINE_PRIM(_IDL, btBroadphaseInterface_getOverlappingPairCache0, _IDL);
...
HL_PRIM float HL_NAME(btTypedConstraint_getAppliedImpulse0)(_ref(btTypedConstraint)* _this) {
	return _unref(_this)->getAppliedImpulse();
}
DEFINE_PRIM(_F32, btTypedConstraint_getAppliedImpulse0, _IDL);

HL_PRIM void HL_NAME(btTypedConstraint_setEnabled1)(_ref(btTypedConstraint)* _this, bool enabled) {
	_unref(_this)->setEnabled(enabled);
}
DEFINE_PRIM(_VOID, btTypedConstraint_setEnabled1, _IDL _BOOL);

HL_PRIM bool HL_NAME(btTypedConstraint_isEnabled0)(_ref(btTypedConstraint)* _this) {
	return _unref(_this)->isEnabled();
}
DEFINE_PRIM(_BOOL, btTypedConstraint_isEnabled0, _IDL);
